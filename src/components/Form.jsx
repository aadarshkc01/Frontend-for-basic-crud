...
<form action="https://fabform.io/f/xxxxx" method="post" className="max-w-md mx-auto mt-20 p-6 bg-white border rounded-lg shadow-lg">
  ...
  <div className="mb-4">
    ...
    <textarea className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="feedback" rows={5} placeholder="Enter your feedback" defaultValue={""} />
  </div>
